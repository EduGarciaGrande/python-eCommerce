...
# When a new user is logged in, this signal deletes all previous sessions for that new user (in case they exist)
...
# If a user is not active, delete al sessions related to them
